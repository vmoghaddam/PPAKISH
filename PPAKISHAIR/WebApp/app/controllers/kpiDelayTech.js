'use strict';
app.controller('kpiDelayTechController', ['$scope', '$location', 'personService', 'authService', 'biService', '$routeParams', '$rootScope', function ($scope, $location, personService, authService, biService, $routeParams, $rootScope) {
    $scope.fieldName = '';
    $scope.indexName = '';
    $scope.ds_month = [
    ...
    $scope.selectType = function (t) {
        ...
        $scope.dg_monthly2_ds = Enumerable.From($scope.total.items)
            .Where(function (x) { return oyears.indexOf(Number(x.Year)) != -1 && $scope.selectedTypes.indexOf(x.ICategory) != -1; })
            .OrderBy('Number($.Year)')
            .ThenBy('Number($.Month)')
            .ThenBy('$.ICategory')
            .ToArray();
        ...
        $scope.dg_daily2_ds = Enumerable.From($scope.ds_daily.items)
            .Where(function (x) { return oyears.indexOf(Number(x.Year)) != -1 && smsids.indexOf(Number(x.Month)) != -1 && $scope.selectedTypes.indexOf(x.ICategory) != -1; })
            .OrderBy('Number($.Year)')
            .ThenBy('Number($.Month)')
            .ThenBy('Number($.Day)')
            .ThenBy('$.ICategory')
    ...
    $scope.popup = {
                ...
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'Details', onClick: function (e) {
                        ...
                        var data = {
                            ...
                            initialCats: $scope.selectedTypes,
                        ...
                        $rootScope.$broadcast('InittblDelayTech', data)
                    }
                }, toolbar: 'bottom'
            },
            {
        ...
        onShowing: function (e) {
            ...
            $scope.scroll_1_height = $(window).height() - 270;
    ...
    $scope.rebuild = function () {
        ...
        $.each(/*newMainSeries*/$scope.years, function (_i, _d) {
            ...
            var delaySeries = {
                ...
                //visible: $scope.selected.indexOf(_t.ICategory) != -1,
            ...
            //4-17
            $.each($scope.grouped, function (_j, _t) {
                if ($scope.selectedTypes.indexOf(_t.Register) != -1) {

                    $scope.polarTime30Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D30Time_' + _d,
                    ...
                    $scope.polarTime30pSeries.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D30pTime_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polarTime180Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D180Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polarTime3060Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D3060Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polarTime60120Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D60120Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polarTime120180Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D120180Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polar30Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D30_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polar30pSeries.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D30p_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polar180Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D180_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polar3060Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D3060_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polar60120Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D60120_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polar120180Series.push({
                        name: _t.Register + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.Register + '_' + 'D120180_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    // item[row.ICategory + '_' + 'D30Time_' + row.Year]
                    var dlSeries = {
                        year: _d,
                        valueField: 'Delay' + '_' + _d + '_' + _t.Register,
                        name: _t.Register + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.Register) != -1,
                    };
                    var dl2Series = {
                        year: _d,
                        valueField: 'Delay' + '_' + _d + '_' + _t.Register,
                    ...
                    var countSeries = {
                        year: _d,
                        valueField: 'Count' + '_' + _d + '_' + _t.Register,
                        name: _t.Register + ' (' + _d + ')',
                        showInLegend: false,
                        pane: 'occurance',
                        type: 'spline',
                    ...
                    var dcSeries = {
                        year: _d,
                        valueField: 'DelayPerLeg' + '_' + _d + '_' + _t.Register,
                        name: _t.Register + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.Register) != -1,
                    ...
                    var ocSeries = {
                        year: _d,
                        valueField: 'CountPerLeg' + '_' + _d + '_' + _t.Register,
                        name: _t.Register + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.Register) != -1,
                    ...
                    var delayRatioSeries = {
                        year: _d,
                        name: 'Ratio ' + _t.Register + ' (' + _d + ')', pane: "delayRatio", type: 'spline', valueField: 'DelayRatio' + '_' + _d + '_' + _t.Register,
                    ...
                    //var reglegSeries = {
                    //    year: _d,
                    //    name: 'Cycles ' + _t.Register + ' (' + _d + ')', pane: "dis", type: 'bar', valueField: 'DistanceKM' + '_' + _d + '_' + _t.RegisterID,
                    //    visible: $scope.selectedTypes.indexOf(_t.RegisterID) != -1,
                    //    color: $rootScope.getColorFromSet2(c), showInLegend: false,
                    //};
                    var reglegSeries = {
                        year: _d,
                        valueField: 'AFlightCount' + '_' + _d + '_' + _t.Register,
                        name: _t.Register + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.Register) != -1,
                    ...
                    $scope.mainlegSeries.push(reglegSeries);
    ...
    $scope.polar_time3060 = {
        ...
        title: {
            text: 'Duration of Delays Between 30 to 60 minutes',
            font: {
                size: 18,
            }
        },
    ...
    $scope.polar_time60120 = {
        ...
        title: {
            text: 'Duration of Delays Between 1 to 2 hours',
            font: {
                size: 18,
            }
        },
    ...
    $scope.polar_time120180 = {
        ...
        title: {
            text: 'Duration of Delays Between 2 to 3 hours',
            font: {
                size: 18,
            }
        },
    ...
    $scope.polar_3060 = {
        ...
        title: {
            text: 'Occurance of Delays Between 30 to 60 minutes',
            font: {
                size: 18,
            }
        },
    ...
    $scope.polar_60120 = {
        ...
        title: {
            text: 'Occurance of Delays Between 1 to 2 hours',
            font: {
                size: 18,
            }
        },
    ...
    $scope.polar_120180 = {
        ...
        title: {
            text: 'Occurance of Delays Between 2 to 3 hours',
            font: {
                size: 18,
            }
        },
    ...
    $scope.chart_monthly_rpk = {
        ...
        // palette:'Soft Pastel',
        bindingOptions: {
            "dataSource": "total.technicalRegisters",
            series: 'mainSeries',
    ...
    ////////////////////////////////////////
    $scope.chart_monthly_legs_instance = null;
    $scope.chart_monthly_legs = {
        pointSelectionMode: "multiple",
        argumentAxis: {
            label: {
                displayMode: 'rotate',
        ...
        onInitialized: function (e) {
            if (!$scope.chart_monthly_legs_instance)
                $scope.chart_monthly_legs_instance = e.component;
        },
    ...
    */
    ...
    $scope.year = null;
    $scope.grouped = null;
    $scope.$on('InitkpiTech', function (event, prms) {
        ...
        $scope.selectedTypes.push(prms.type.Register);
