'use strict';
app.controller('airportController', ['$scope', '$location', '$routeParams', '$rootScope', 'airportService', 'authService', '$route', function ($scope, $location, $routeParams, $rootScope, airportService, authService,$route) {
