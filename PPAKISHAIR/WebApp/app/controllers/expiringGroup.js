'use strict';
app.controller('expiringGroupController', ['$scope', '$location', '$routeParams', '$rootScope', 'courseService', 'authService', 'trnService', function ($scope, $location, $routeParams, $rootScope, courseService, authService, trnService) {
    ...
    $scope.dg_course = {
        ...
        onCellPrepared: function (e) {
            ...
            if (e.rowType === "data" && e.column.dataField == "Name") {
                $scope.styleCell(e, e.data.Remains);
            }
        },
