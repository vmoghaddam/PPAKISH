'use strict';
app.controller('jobgroupSelectSimpleController', ['$scope', '$location', 'authService', '$routeParams', '$rootScope', function ($scope, $location, authService, $routeParams, $rootScope) {
    ...
    $scope.popup_add.toolbarItems[0].options.onClick = function (e) {
        ...
        $rootScope.$broadcast('onJobGroupSelectSimpleHide', $scope.dg_selected);
        $scope.popup_add_visible = false;
    };
    ////////////////////////////
    $scope.bind = function () {
