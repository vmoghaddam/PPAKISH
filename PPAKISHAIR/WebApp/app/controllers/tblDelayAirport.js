'use strict';
app.controller('tblDelayAirportController', ['$scope', '$location', 'personService', 'authService', 'biService', '$routeParams', '$rootScope', function ($scope, $location, personService, authService, biService, $routeParams, $rootScope) {
    ...
    $scope.bindMaster = function () {
        ...
        $scope.dg_master_ds = Enumerable.From($scope.airports)
            .Where(function (x) {
                return $scope.years.indexOf(x.Year) != -1 && $scope.selectedTypes.indexOf(x.Airport) != -1;
            })
            .ToArray();
