...
app.controller('boardController', ['$scope', '$location', '$routeParams', '$rootScope', '$timeout', 'flightService', 'weatherService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', 'fbService', '$http','$q', function ($scope, $location, $routeParams, $rootScope, $timeout, flightService, weatherService, aircraftService, authService, notificationService, $route, $window, fbService, $http,$q) {
 ...
 $scope.btn_delete = {
    ...
    $scope.cl_checkin_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLCheckIn'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCheckIn), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_park_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLPark'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLPark), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_add_tools_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLAddTools'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLAddTools), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_bus_ready_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLBusReady'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBusReady), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_pax_out_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLPaxOut'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLPaxOut), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_depo_out_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLDepoOut'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLDepoOut), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_service_presence_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLServicePresence'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLServicePresence), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_cleaning_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLCleaningStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCleaningStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_tech_ready_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLTechReady'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLTechReady), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_bag_sent_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLBagSent'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBagSent), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_catering_load_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLCateringLoad'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCateringLoad), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_fuel_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLFuelStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLFuelStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_fuel_end_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLFuelEnd'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLFuelEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_cleaning_end_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLCleaningEnd'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLCleaningEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_boarding_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLBoardingStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBoardingStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_boarding_end_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLBoardingEnd'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLBoardingEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_loadsheet_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLLoadSheetStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadSheetStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_gate_closed = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLGateClosed'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLGateClosed), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_traffic_crew_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLTrafficCrew'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLTrafficCrew), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_load_crew_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLLoadCrew'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadCrew), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_forbidden_obj_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLForbiddenObj'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLForbiddenObj), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_loadsheet_sign_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLLoadSheetSign'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadSheetSign), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_loading_end_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLLoadingEnd'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLLoadingEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_door_closed_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLDoorClosed'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLDoorClosed), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_eq_dc_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLEqDC'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLEqDC), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_motor_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLMotorStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLMotorStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_moving_starrt_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLMovingStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLMovingStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_gpu_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLGPUStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLGPUStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_gpu_end_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLGPUEnd'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLGPUEnd), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_ac_start_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLACStart'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLACStart), new Date($scope.logFlight.STD2));
    ...
    $scope.cl_ac_end_hh = {type: "time", pickerType: "rollers", displayFormat: "HH:mm", interval: 15,bindingOptions: {value: 'logFlight.CLACEnd'},
        onValueChanged: function (arg) {var shiftDay = CompareDateByHour(new Date($scope.logFlight.CLACEnd), new Date($scope.logFlight.STD2));
             ...
             
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'Crew List', icon: 'save', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
                        ...
                        var idsStr = ids.join('_');
                        $window.open('https://api.apvaresh.ir/' + 'api/xls/cl?flts=' + idsStr, '_blank');
            ...
            },
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'GD', icon: 'save', bindingOptions: { disabled: 'IsApproved' }, onClick: function (arg) {
                        ...
                        var idsStr = ids.join('_');
                        $window.open('https://api.apvaresh.ir/' + 'api/xls/gd?flts=' + idsStr, '_blank');
                    }
