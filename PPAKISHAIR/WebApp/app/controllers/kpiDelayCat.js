'use strict';
app.controller('kpiDelayCatController', ['$scope', '$location', 'personService', 'authService', 'biService', '$routeParams', '$rootScope', function ($scope, $location, personService, authService, biService, $routeParams, $rootScope) {
    $scope.fieldName = '';
    $scope.indexName = '';
    $scope.ds_month = [
        ...
        toolbarItems: [
            {
                widget: 'dxButton', location: 'after', options: {
                    type: 'default', text: 'Details', onClick: function (e) {
                        ...
                        $rootScope.$broadcast('InittblDelayCat', data)
                    }
                }, toolbar: 'bottom'
            },
            {
    ...
    $scope.rebuild = function () {
        ...
        $.each(/*newMainSeries*/$scope.years, function (_i, _d) {
           ...
           // $scope.mainSeries.push(delaySeries);
            ...
            $.each($scope.grouped, function (_j, _t) {
                if ($scope.selectedTypes.indexOf(_t.ICategory) != -1)
                {
                    
                    $scope.polarTime30Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D30Time_' + _d,
                    ...
                    $scope.polarTime30pSeries.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D30pTime_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polarTime180Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D180Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polarTime3060Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D3060Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polarTime60120Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D60120Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polarTime120180Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D120180Time_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polar30Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D30_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polar30pSeries.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D30p_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    ...
                    $scope.polar180Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D180_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polar3060Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D3060_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polar60120Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D60120_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    $scope.polar120180Series.push({
                        name: _t.ICategory + ' ' + _d,
                        argumentField: 'argStr',
                        valueField: _t.ICategory + '_' + 'D120180_' + _d,
                        color: $rootScope.getColorFromSet2(c),
                    });
                    // item[row.ICategory + '_' + 'D30Time_' + row.Year]
                    var dlSeries = {
                        year: _d,
                        valueField: 'Delay' + '_' + _d + '_' + _t.ICategory,
                        name: _t.ICategory + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.ICategory) != -1,
                    };
                    var dl2Series = {
                        year: _d,
                        valueField: 'Delay' + '_' + _d + '_' + _t.ICategory,
                    ...
                    var countSeries = {
                        year: _d,
                        valueField: 'Count' + '_' + _d + '_' + _t.ICategory,
                        name: _t.ICategory + ' (' + _d + ')',
                        showInLegend: false,
                        pane: 'occurance',
                        type: 'spline',
                    ...
                    var dcSeries = {
                        year: _d,
                        valueField: 'DelayPerLeg' + '_' + _d + '_' + _t.ICategory,
                        name: _t.ICategory + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.ICategory) != -1,
                    ...
                    var ocSeries = {
                        year: _d,
                        valueField: 'CountPerLeg' + '_' + _d + '_' + _t.ICategory,
                        name: _t.ICategory + ' (' + _d + ')',
                        showInLegend: true,
                        color: $rootScope.getColorFromSet2(c),
                        visible: $scope.selectedTypes.indexOf(_t.ICategory) != -1,
                    ...
                    var delayRatioSeries = {
                        year: _d,
                        name: 'Ratio ' + _t.ICategory + ' (' + _d + ')', pane: "delayRatio", type: 'spline', valueField: 'DelayRatio' + '_' + _d + '_' + _t.ICategory,
    ...
    */
    ...
    $scope.year = null;
    $scope.grouped = null;
    $scope.$on('InitkpiCat', function (event, prms) {
        $scope.selectedTypes = [];
        $scope.prms = null;
        $scope.total = null;
        $scope.month = null;
        ...
        $scope.selectedTypes.push(prms.type.ICategory);
