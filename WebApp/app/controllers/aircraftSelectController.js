'use strict';
app.controller('aircraftSelectController', ['$scope', '$location', 'aircraftService', 'authService', '$routeParams', '$rootScope', function ($scope, $location, aircraftService, authService, $routeParams, $rootScope) {
    ...
    $scope.popup_add_title = 'Aircraft Types';
    $scope.popup_add = {
    ...
    $scope.popup_add.toolbarItems[0].options.onClick = function (e) {
        ...
        $rootScope.$broadcast('onAircraftSelectHide', $scope.dg_selected);
        $scope.popup_add_visible = false;
    };
    ////////////////////////////
    $scope.bind = function () {
    ...
    $scope.$on('InitAircraftSelect', function (event, prms) {
