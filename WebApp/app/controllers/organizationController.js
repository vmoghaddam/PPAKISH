...
app.controller('organizationController', ['$scope', '$location', '$routeParams', '$rootScope', 'organizationService', 'authService', '$route', function ($scope, $location, $routeParams, $rootScope, organizationService, authService, $route) {
    ...
    $scope.dg_columns_publisher = [
        ...
        { dataField: 'SortName', caption: 'Sort Name', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100 },
        { dataField: 'Country', caption: 'Country', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 170 },
