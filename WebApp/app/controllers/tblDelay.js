'use strict';
app.controller('tblDelayController', ['$scope', '$location', 'personService', 'authService', 'biService', '$routeParams', '$rootScope', function ($scope, $location, personService, authService, biService, $routeParams, $rootScope) {
    ...
    $scope.popup = {
        ...
        toolbarItems: [
            {
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: 'Hide/Show Master', onClick: function (e) {
                        //  $scope.dg_monthly2_instance.refresh();
                        if ($scope.isDetailVisible) {
                            $scope.isMasterVisible = !$scope.isMasterVisible;
                            setTimeout(function () {
        ...
        onShown: function (e) {
            ...
            $scope.dg_master_instance.columnOption('OTF', 'visible', ['OTF','OTFC','DOTF'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('OTFC', 'visible', ['OTF', 'OTFC'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DF', 'visible', ['DF', 'DFC','DOTF'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC', 'visible', ['DF', 'DFC'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DOTF', 'visible', [ 'DOTF'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DF-30', 'visible', ['DF-30', 'DFC-30','FD-30'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC-30', 'visible', ['DF-30', 'DFC-30', 'FD-30'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DF+30', 'visible', ['DF+30', 'DFC+30','FD30'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC+30', 'visible', ['DF+30', 'DFC+30', 'FD30'].indexOf($scope.indexName) != -1);


            $scope.dg_master_instance.columnOption('DF3060', 'visible', ['DF3060', 'DFC3060', 'FD3060'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC3060', 'visible', ['DF3060', 'DFC3060', 'FD3060'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DF60120', 'visible', ['DF60120', 'DFC60120', 'FD60120'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC60120', 'visible', ['DF60120', 'DFC60120', 'FD60120'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DF120180', 'visible', ['DF120180', 'DFC120180', 'FD120180'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC120180', 'visible', ['DF120180', 'DFC120180', 'FD120180'].indexOf($scope.indexName) != -1);

            $scope.dg_master_instance.columnOption('DF+180', 'visible', ['DF+180', 'DFC+180','FD180'].indexOf($scope.indexName) != -1);
            $scope.dg_master_instance.columnOption('DFC+180', 'visible', ['DF+180', 'DFC+180', 'FD180'].indexOf($scope.indexName) != -1);


            $scope.dg_master_instance.columnOption('DC', 'visible', ['DC'].indexOf($scope.indexName) != -1);
    ...
    $scope.dg_master_columns2 = [
        ...
        { dataField: 'Airport', caption: 'A/P', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, minWidth: 95, fixed: true, fixedPosition: 'left', sortIndex: 2, sortOrder: 'asc' },
        {
    ...
    $scope.dg_master_columns = [
        ...
        {
            caption: 'DC', columns: [
                { dataField: 'DelayPerLeg2', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreDelayPerLeg2', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'DelayPerLegDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },

            ], visible: false
        },
        {
            caption: 'Delayed Flights / On-Time Flights', name: 'DOTF', columns: [
                { dataField: 'DelayedFlightsPerOnTime', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreDelayedFlightsPerOnTime', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'DelayedFlightsPerOnTimeDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: 'Delayed Flights / Cycles', name: 'DFC', columns: [
                { dataField: 'DelayedFlightsPerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreDelayedFlightsPerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'DelayedFlightsPerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: 'Delayed Flights', name: 'DF', columns: [
                ...
                { dataField: 'FlightCountDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: 'On-Time Flights / Cycles',name:'OTFC', columns: [
                { dataField: 'OnTimeFlightsPerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreOnTimeFlightsPerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'OnTimeFlightsPerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },
          

            ], visible: false
        },
        {
            caption: 'On-Time Flights', name: 'OTF', columns: [
                { dataField: 'OnTimeFlightCount', name:'OnTimeFlightCount1', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                ...
                { dataField: 'OnTimeFlightCountDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },
        ...
        {
            caption: '-30 mins Delayed Flights / Cycles', name: 'DFC-30', columns: [
                { dataField: 'FltDelayUnder30PerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFltDelayUnder30PerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FltDelayUnder30PerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: '-30 mins Delayed Flights', name: 'DF-30', columns: [
        ...
        {
            caption: '+30 mins Delayed Flights / Cycles', name: 'DFC+30', columns: [
                { dataField: 'FltDelayOver30PerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFltDelayOver30PerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FltDelayOver30PerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },
        ...
        {
            caption: '30-60 mins Delayed Flights / Cycles', name: 'DFC3060', columns: [
                { dataField: 'FltDelay3060PerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFltDelay3060PerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FltDelay3060PerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: '30-60 mins Delayed Flights', name: 'DF3060', columns: [
        ...
        {
            caption: '1-2 hrs Delayed Flights / Cycles', name: 'DFC60120', columns: [
                { dataField: 'FltDelay60120PerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFltDelay60120PerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FltDelay60120PerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: '1-2 hrs Delayed Flights', name: 'DF60120', columns: [
        ...
        {
            caption: '2-3 hrs Delayed Flights / Cycles', name: 'DFC120180', columns: [
                { dataField: 'FltDelay120180PerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFltDelay120180PerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FltDelay120180PerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },


            ], visible: false
        },
        {
            caption: '2-3 hrs Delayed Flights', name: 'DF120180', columns: [
        ...
        {
            caption: '+3 hrs Delayed Flights / Cycles', name: 'DFC+180', columns: [
                { dataField: 'FltDelayOver180PerAll', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFltDelayOver180PerAll', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FltDelayOver30PerAllDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 120 },
        ...
        {
            caption: '+3 hrs Delayed Flights', name: 'DF+180', columns: [
        ...
        {
            caption: 'On-Time',name:'_OnTime', columns: [
                { dataField: 'OnTimeFlightCount', name: 'OnTimeFlightCount2', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreOnTimeFlightCount', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
        ...
        {
            caption: 'Delayed',name:'_Delayed', columns: [
                { dataField: 'FlightCount', name:'FlightCount2', caption: 'Current', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'PreFlightCount', caption: 'Past', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                { dataField: 'FlightCountDiff', caption: 'Inc(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
                //{ dataField: 'DelayedFlightsPerAll', caption: 'Ratio(%)', allowResizing: true, alignment: 'center', dataType: 'numer', allowEditing: false, width: 100 },
            ]
        },
        {
    ...
    $scope.bindMaster = function () {
        ...
        $scope.dg_master_ds = Enumerable.From($scope.total.items)
            .Where(function (x) { return $scope.years.indexOf(Number(x.Year)) != -1 })
            .OrderBy('Number($.Year)')
            .ThenBy('Number($.Month)')
    ...
    $scope.$on('InittblDelay', function (event, prms) {
        ...
        $scope.summary = $scope.prms.total.yearSummary;
