...
app.controller('reportFlightDailyController', ['$scope', '$location', '$routeParams', '$rootScope', 'flightService', 'aircraftService', 'authService', 'notificationService', '$route', '$window', function ($scope, $location, $routeParams, $rootScope, flightService, aircraftService, authService, notificationService, $route, $window) {
    ...
    $scope.bind = function () {
        ...
        flightService.getFlightDailyReport(_df,_dt,_org,_des,_regs,_route,_no).then(function (response) {
    ...
    $scope.dg_flight_columns = [];
        ...
        $scope.dg_flight_columns = [
            ...
            { dataField: 'PMonth', caption: 'ماه', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100,    fixed: false, fixedPosition: 'left' },
            { dataField: 'FlightType2', caption: 'نوع پرواز', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100,   fixed: false, fixedPosition: 'left' },
            { dataField: 'FlightIndex', caption: 'شاخص', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100,   fixed: false, fixedPosition: 'left' },
            { dataField: 'PDayName', caption: 'روز', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 100,   fixed: false, fixedPosition: 'left' },

            { dataField: 'STDDay', caption: 'تاریخ میلادی', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 120, format: 'yy-MMM-dd', sortIndex: 0, sortOrder: 'asc', fixed: false, fixedPosition: 'left' },
            { dataField: 'PDate', caption: 'تاریخ شمسی', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120, fixed: false, fixedPosition: 'left' },
            { dataField: 'FlightNumber', caption: 'شماره پرواز', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80,   fixed: false, fixedPosition: 'left' },
            { dataField: 'AircraftType', caption: 'نوع هواپیما', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, sortIndex: 1, sortOrder: 'asc' },
            { dataField: 'Register', caption: 'رجیستر', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 130, sortIndex: 2, sortOrder: 'asc' },
            { dataField: 'FromAirportIATA', caption: 'مبدا', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80 },
            { dataField: 'ToAirportIATA', caption: 'مقصد', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 80 },

            {
                caption: 'مسافر حمل شده', columns: [
                    { dataField: 'PaxAdult', caption: 'ADL', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
                    { dataField: 'PaxChild', caption: 'CHD', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
                    { dataField: 'PaxInfant', caption: 'INF', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
                    { dataField: 'RevPax', caption: 'Rev.', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
                    { dataField: 'TotalPax', caption: 'Total', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
                ]
            },
            { dataField: 'AirlineSold', caption: 'فروش تابان', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,   },
            { dataField: 'ChertererSold', caption: 'فروش چارتری', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,   },

            { dataField: 'BaggageWeight', caption: 'بار حمل شده', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
            { dataField: 'CargoWeight', caption: 'بار حمل شده کارگو', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },

            { dataField: 'TotalSeat', caption: 'ظرفیت', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
            { dataField: 'EmptySeat', caption: 'صندلی خالی', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
            { dataField: 'OverSeat', caption: 'اوری', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
           

            { dataField: 'STDLocal', caption: 'STD', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', sortIndex: 3, sortOrder: 'asc' },
            ...
            { dataField: 'ScheduledTime2', caption: 'Fix Time', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,   },

            { dataField: 'TakeOffLocal', caption: 'خروج حقیقی', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', },
            { dataField: 'LandingLocal', caption: 'ورود حقیقی', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', },
            ...
            { dataField: 'BlockOffLocal', caption: 'BlockO ff', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', },
            { dataField: 'BlockOnLocal', caption: 'Block On', allowResizing: true, alignment: 'center', dataType: 'datetime', allowEditing: false, width: 115, format: 'HH:mm', },
            { dataField: 'BlockTime2', caption: 'Block Time', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,   },
            
            { dataField: 'Delay2', caption: 'تاخیر', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,   },
            { dataField: 'DelayReason', caption: 'دلیل تاخیر', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,  },

            { dataField: 'UsedFuel', caption: 'سوخت', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
            { dataField: 'Distance', caption: 'مسافت', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },
            { dataField: 'ChrTitle', caption: 'چارترکننده', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 120,   },
            { dataField: 'StationIncome', caption: 'درآمد ایستگاه', allowResizing: true, alignment: 'center', dataType: 'number', allowEditing: false, width: 100, },

            {caption:'آژانس های طرف قرارداد',width:300},
            { dataField: 'Remark', caption: 'توضیحات', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 250,   },
